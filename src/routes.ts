...
const controladorListarTotalHectarFazenda =
  new ControladorListarTotalHectarFazenda();
const controladorListarTotalHectarFazendaEstado =
  new ControladorListarTotalHectarFazendaEstado();
const controladorListarTotalHectarFazendaCultivo =
  new ControladorListarTotalHectarFazendaCultivo();
const controladorListarAgricTotalHectarFazenda =
  new ControladorListarAgricTotalHectarFazenda();
const controladorListarVegeTotalHectarFazenda =
  new ControladorListarVegeTotalHectarFazenda();
...
router.get(
  ...
  autenticacao,
  usuarioAdmin,
  controladorListarTotalFazenda.handle
);
router.get(
  "/totalHectarFazenda",
  autenticacao,
  usuarioAdmin,
  controladorListarTotalHectarFazenda.handle
);
router.get(
  "/totalHectarFazendaEstado",
  autenticacao,
  usuarioAdmin,
  controladorListarTotalHectarFazendaEstado.handle
);
router.get(
  "/totalHectarFazendaCultura",
  autenticacao,
  usuarioAdmin,
  controladorListarTotalHectarFazendaCultivo.handle
);
router.get(
  "/totalHectarFazendaCulturaAgric",
  autenticacao,
  usuarioAdmin,
  controladorListarAgricTotalHectarFazenda.handle
);
router.get(
  "/totalHectarFazendaCulturaVeget",
  autenticacao,
  usuarioAdmin,
  controladorListarVegeTotalHectarFazenda.handle
);
